...
public class TestForUnsuccessfulLoginLongPassword {
	WebDriver driver;
	...
	public void testForLogin() throws Exception{
		...
		login.clickLogIn();
		login.inputEmail("monikapetrov988@gmail.com");
		login.inputPass("pasvordJeDuziOdTridesetKaraktera");
		login.clickSubmit();
		Thread.sleep(5000);
	
		Assert.assertEquals(driver.getCurrentUrl(), "https://qa-sandbox.apps.htec.rs/login");
		Assert.assertTrue(login.errorIsDisplayed());
	}	
}
